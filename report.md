...
20. Далее надо было решить задачу, написав скрипт, который проверяет, что все файлы расширения .txt соответствуют определённому формату. На рисунке 29 представлен скрипт, который проверяет название текстового файла на наличие там слова "book".
